...
<section id="scores">
	...
	<aside class="text-width">
		<div class="inner-content">
			...
			<p><strong>I</strong>ndividualized <strong>E</strong>ducation <strong>P</strong>lans (<strong>IEP</strong>s), outline what supports a student with disabilities will need to be able to work towards their educational goals. They're created by teams of teachers, therapists, the student, and their caregivers</p>
		</div>
	</aside>
